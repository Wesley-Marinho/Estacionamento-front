...
@Component({
  selector: 'app-veiculo-bind-rotativo',
  templateUrl: './veiculo-bind-rotativo.component.html',
  styleUrls: ['./veiculo-bind-rotativo.component.css']
})
export class VeiculoBindRotativoComponent implements OnInit {
  id_rotativo = ''
  ...
  updateByRotativo(){
    this.service.updateByRotativo(this.veiculo,this.id_rotativo).subscribe((res) => {
      ...
      this.service.mensagem('Veiculo vinculado com sucesso')
    }, err => {
